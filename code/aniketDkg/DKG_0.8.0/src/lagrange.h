...
const std::vector <Zr> lagrange_coeffs(const std::vector <Zr> indices, const Zr& alpha);
...
const G1 lagrange_apply(const std::vector <Zr> coeffs, const std::vector <G1> shares);
//For Zr
const Zr lagrange_apply(const std::vector <Zr> coeffs, const std::vector <Zr> shares);
#endif
