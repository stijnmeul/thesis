...
\label{def:cyclic_group}
 A group $G$ is \textit{cyclic} if and only if $\exists g \in G, \forall b \in G, \exists n \in \mathbb{Z}: g^n = b$. Such an element $g$ is called a \textit{generator} of $\mathbb{G}$.
\end{defn}
