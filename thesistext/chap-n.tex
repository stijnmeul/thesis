...
\begin{figure}
    ...
    \noindent\makebox[\textwidth]{
        \scalebox{0.72} {
        \begin{tikzpicture}
        \begin{abstractclass}[text width =9 cm]{BroadcastMessage}{0,0}
          \attribute{\# message : std::string }
        ...
        \end{abstractclass}
        \begin{class}[text width =7 cm]{CheckingAccount}{ -8 , -8}
        ...
        \end{class}
        \begin{class}[text width =7 cm]{ SavingsAccount }{8 , -8}
          \inherit{BroadcastMessage}
    ...
    \caption{Class Diagram of C++ MIRACL Based Back-end}
