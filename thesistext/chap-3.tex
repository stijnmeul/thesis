...
\begin{figure}[ht]
    ...
    \scalebox{0.78}{
       ...
       \node[below=of pkg1] {\textbf{DKG 1}};
       \node[below=of pkg2] {\textbf{DKG 2}};
       \node[below=of pkg3] {\textbf{DKG 3}};
       \node[below=of pkg4] {\textbf{DKG 4}};
