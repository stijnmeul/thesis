...
scrambleAppNS.htmlactions = {
    ...
    mycolor: function() {
        var prefs = scrambleUtils.getPreferences();
        var color = prefs.getCharPref("color");
        dump("\n\n\n\n color: "+color+"\n\n\n\n ");
        return color;
    },
