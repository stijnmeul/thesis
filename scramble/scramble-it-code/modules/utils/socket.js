        ...
        var instream = Cc["@mozilla.org/scriptableinputstream;1"].
         ...
         var dataListener = {
             ...
             onStartRequest: function(request, context) {
                 // dump("\n\n============================================================\n")
                 dump("ScrambleClient SOCKET: Connected to ScrambleSocketServer [port: "+port+" | host: "+server+"]\n");
                 // dump("\n============================================================\n\n")
             ...
             onStopRequest: function(request, context, status) {
                 // dump("ScrambleClient SOCKET:"+receivedData+"\n");
         ...
         NetUtil.asyncCopy(inputStr, outstream, function(aResult) {
             if (!Components.isSuccessCode(aResult)) {
                 dump("ScrambleClient SOCKET: ERROR: writing to socket\n");
